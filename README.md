...
- In response dotpay service send back data with the operation data and payment signature. Then the signature and data is compared with signature generated by the application and data stored in order models. If everything is correct, the backend creates models for order and changes user's Premium Plan. 
